...
OBJECTS := objs/material.o objs/planeSegment.o objs/plane.o objs/detector.o objs/plf.o objs/frag.o objs/tele.o objs/array.o objs/sle.o objs/decay.o objs/loss.o objs/mScat.o objs/fragment.o objs/random.o objs/tower.o objs/frame.o objs/MomDist.o objs/moscow.o objs/ring.o objs/ttt.o objs/plane_det.o
